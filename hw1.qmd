---
title: "Homework 1"
author: "[sifei zhou]{style='background-color: yellow;'}"
toc: true
...
```{R}
#the row_wise_scan function is faster, because R stores matrices in column-major order 
```
...
```{R}
# as the matrix size increases, the difference in execution times become larger
```
